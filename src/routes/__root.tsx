...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Perseidas — Disparo em massa de WhatsApp com rotação de chips" },
      ...
      { property: "og:title", content: "Perseidas — Disparo em massa de WhatsApp com rotação de chips" },
      ...
      { name: "twitter:title", content: "Perseidas — Disparo em massa de WhatsApp com rotação de chips" },
