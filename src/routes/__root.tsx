...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "ZapBlast — Disparo em massa de WhatsApp com rotação de chips" },
      ...
      { name: "twitter:title", content: "ZapBlast — Disparo em massa de WhatsApp com rotação de chips" },
