...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "ZapBlast — Disparo em massa de WhatsApp" },
      { property: "og:description", content: "Rotação inteligente de chips, anti-ban e spintax. Conecte sua Evolution API." },
